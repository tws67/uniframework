...
namespace Uniframework.SharePoint.Linq.EntityGenerator
{
    ...
    public class Generator
    {
        ...
        public CodeCompileUnit GenerateCode(XmlDocument spml, out bool enableObjectModelProvider)
        {
            ...
            ns.Imports.Add(new CodeNamespaceImport("Uniframework.SharePoint.Linq"));
        ...
        private static CodeTypeDeclaration GenerateSharePointDataContext(Context context, Dictionary<List, string> entities)
        {
            ...
            if (context.EnableObjectModelProvider)
            {
                ...
                omCtor.BaseConstructorArgs.Add(new CodeObjectCreateExpression(new CodeTypeReference("Uniframework.SharePoint.Linq.Providers.ObjectModelSharePointDataProvider", CodeTypeReferenceOptions.GlobalReference), new CodeSnippetExpression("site")));
