...
namespace Uniframework.SmartClient
{
    ...
    /// DevExpress表格文档适配器
    /// </summary>
    public class XtraGridDocumentAdapter : IDocumentHandler, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XtraGridDocumentAdapter"/> class.
        /// </summary>
        /// <param name="adaptee">The adaptee.</param>
        public XtraGridDocumentAdapter(GridControl adaptee)
        {
