...
namespace Uniframework
{
    ...
    public static class PackageUtility
    {
        ...
        public static readonly string METHOD_DECLARETYPE      = "context_uf_method_declaretype"; // 方法定义的类型
        public static readonly string METHOD_ISGENERIC        = "context_uf_method_isgeneric"; // 是否是泛型方法
        public static readonly string METHOD_GENERICARGUMENTS = "context_uf_method_genericarguments"; // 泛型参数
        ...
        //    package.Context[METHOD] = serializer.Serialize<MethodInfo>(method);
        //    package.Context[METHOD_NAME] = serializer.Serialize<string>(method.Name);
        //    package.Context[METHOD_DECLARETYPE] = serializer.Serialize<Type>(method.DeclaringType);
        //    package.Context[METHOD_ISGENERIC] = serializer.Serialize<bool>(method.IsGenericMethod);
        //    package.Context[METHOD_GENERICARGUMENTS] = serializer.Serialize<Type[]>(method.GetGenericArguments());
        //    package.Context[METHOD_PARAMETERS] = SecurityUtility.DESEncrypt(serializer.Serialize<object>(parameters), encryptKey);
        //}
    }
}
